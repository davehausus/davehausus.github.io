...
hero:
  tagline: Nomo exists to reduce uncertainty through thoughtful technology that helps caregivers feel informed while preserving the dignity and independence of those receiving care.
  image:
