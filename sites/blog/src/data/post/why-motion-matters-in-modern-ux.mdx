...
<BlogSteps title="Key reasons motion matters now">
  <BlogStep title="It clarifies changes and reduces cognitive load during interactions." icon="tabler:thinking-high">
  </BlogStep>
  <BlogStep title="It communicates hierarchy and state quickly and intuitively." icon="tabler:layout-cards">
  </BlogStep>
  <BlogStep title="It creates predictable patterns that build user trust over time." icon="tabler:repeat">
  </BlogStep>
  <BlogStep title="It connects screens and actions into a coherent narrative." icon="tabler:hand-click">
  </BlogStep>
  <BlogStep title="It raises the perceived polish and quality of the product." icon="tabler:eye-spark">
  </BlogStep>
  </BlogSteps>
