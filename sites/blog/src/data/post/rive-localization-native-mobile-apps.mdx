...
<BlogSteps title="What about fonts?">
  ...
  <BlogStep title="Your `.riv` stays tiny" icon="tabler:microscope">
  </BlogStep>
  ...
  <BlogStep title="You avoid the huge jump in file size that embedded fonts cause" icon="tabler:stack-front">
  </BlogStep>
  <Fragment slot="outro">
